/*
 ...
 Developer by: Rojina Computer Ltd (+98 21 41924 ext 9)
...
module.controller('HomeCtrl', ['$scope', '$rootScope', 'Model','$timeout','$interval', function ($scope, $rootScope, Model,$timeout,$interval) {
    ...
    $scope.status= {
        ...
        'not_verified': 'نامه اعتبارسنجی نشانی بدلیل آدرس ناقص (عدم قید شدن شماره پلاک یا واحد) و یا عدم حضور مخاطب در زمان رجوع نامه رسان باطل شده است. دقت نمایید شما مجدد باید در سامانه ثبت نام نمایید و دقت کنید همه اجزای آدرس را صحیح وارد نموده و حتی المقدور مکانی را معرفی کنید که در ساعات اداری فردی در آن حضور داشته باشد.',
...
var adressStatusStatic=[
{id: 2, name: "محل دائمی سکونت  | مالک هستم  | بیش از دو سال در این مکان هستم"},
{id: 1, name: "محل دائمی سکونت  | مالک هستم  | بیش از یکسال و کمتر از دو سال در این مکان هستم"},
{id: 5, name: "محل دائمی سکونت  | مالک هستم  | بزودی تغییر مکان می دهم"},
{id: 4, name: "محل دائمی سکونت  | مستاجر هستم  | بیش از یکسال در این مکان هستم"},
{id: 3, name: "محل دائمی سکونت  | مستاجر هستم  | کمتر از یکسال در این مکان هستم"},
{id: 10, name: "محل موقت سکونت  | در ایران ساکن نیستم و ساکن کشور دیگری هستم"},
{id: 8, name: "محل موقت سکونت |  مالک هستم  | ساکن شهر دیگری هستم"},
{id: 9, name: "محل موقتی سکونت  | نه مالک و نه مستاجر هستم  | بزودی تغییر مکان می دهم"},
{id: 13, name: "محل دائمی کار و تجارت  | مالک یا مستاجر هستم  | بتازگی در این مکان هستم (کمتر از دوماه)"},
{id: 7, name: "محل دائمی کار و تجارت  | مالک هستم  | بیش از یکسال در این مکان هستم"},
{id: 6, name: "محل دائمی کار و تجارت  | مالک هستم  | کمتر از یکسال در این مکان هستم (بیش از دو ماه)"},
{id: 11, name: "محل دائمی کار و تجارت  | مستاجر هستم  | بیش از یکسال در این مکان هستم"},
{id: 12, name: "محل دائمی کار و تجارت  | مستاجر هستم  | کمتر از یکسال در این مکان هستم (بیش از دو ماه)"}
];
